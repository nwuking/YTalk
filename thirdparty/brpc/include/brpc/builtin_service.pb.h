...
class MetricsRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:brpc.MetricsRequest) */ {
 public:
  ...
  inline MetricsRequest* New() const { return New(NULL); }

  MetricsRequest* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
...
class MetricsResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:brpc.MetricsResponse) */ {
 public:
  ...
  inline MetricsResponse* New() const { return New(NULL); }

  MetricsResponse* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
